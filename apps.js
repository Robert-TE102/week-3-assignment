...
function set_cookie(cookie_name, value) {
  ...
  var c_value =
    escape(btoa(JSON.stringify(value))) + "; expires=" + expiry.toUTCString();
...
function saveGame() {
  if (typeof Storage !== "undefined") {
    ...
    localStorage.setItem("myCookieClickerSave", saveString);
...
function loadGame() {
  if (typeof Storage !== "undefined") {
    const savedData = localStorage.getItem("myCookieClickerSave");
    if (savedData) {
